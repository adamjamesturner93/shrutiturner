...
export const PUBLIC_CONTENT_MODELS: ContentTypeDefinition[] = [
  ...
  },
  {
    ...
    displayField: "title",
    description:
      "A dated retreat or online retreat session. Use this for spaces, rooms, payment plans and schedule details.",
    fields: [
      { id: "title", name: "Title", type: "Symbol", required: true },
      { id: "slug", name: "Slug", type: "Symbol", required: true, validations: [{ unique: true }] },
      {
        ...
        type: "Symbol",
        required: true,
        validations: [{ in: ["in_person", "online"] }],
      },
      {
        id: "template",
        name: "Template",
        ...
        linkType: "Entry",
        required: true,
        validations: [{ linkContentType: ["retreatTemplate"] }],
      },
      {
        id: "venue",
        name: "Venue",
      ...
      { id: "timezone", name: "Timezone", type: "Symbol" },
      {
        id: "status",
        name: "Status",
        type: "Symbol",
        required: true,
        validations: [{ in: ["draft", "open", "sold_out", "cancelled", "completed"] }],
      },
      ...
      {
        id: "onlineRoomConfig",
        name: "Online Room Config",
        type: "Object",
      },
      {
        id: "payInFullDiscountEnabled",
        name: "Pay In Full Discount Enabled",
        type: "Boolean",
      },
      { id: "refundNotes", name: "Refund Notes", type: "Text" },
    ],
  },
  {
    id: "authorProfile",
