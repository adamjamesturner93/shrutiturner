...
export const classesProofItems = [
  {
    label: "Live Teaching",
    detail: "Adaptive cueing in real time, not generic prerecorded modifications.",
  },
  {
    label: "Weekly Rhythm",
  ...
  },
  {
    ...
    detail: "Members can scale effort without dropping out of the habit entirely.",
  },
  {
    label: "Intelligent Progression",
    detail: "Build confidence and load tolerance without boom-and-bust cycles.",
  },
] as const;
