      ...
      <div className="section-wash min-h-[calc(100dvh-4rem)] px-4 py-8 md:py-10">
        ...
        {status === "done" ? (
          ...
          <div className="grid gap-6 lg:min-h-[calc(100dvh-12rem)] lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="marketing-grid overflow-hidden rounded-[2rem] px-6 py-7 text-brand-white md:px-8 md:py-8">
              <div className="relative z-10">
                ...
                <p className="mt-5 max-w-md text-lg leading-relaxed text-brand-white/78">
                  Stop receiving marketing emails. For security, we&apos;ll send a confirmation link
                  to the email address you enter.
                </p>

                <div className="mt-8 rounded-[1.5rem] border border-brand-white/10 bg-brand-white/8 p-6">
                  <div className="flex items-center gap-3">
                    <ShieldCheck className="text-brand-accent-light h-5 w-5" />
                    <h2 className="text-lg">What stays on</h2>
                  </div>
                  <p className="mt-3 text-sm leading-relaxed text-brand-white/74">
