        ...
        <div className="prose prose-lg max-w-none space-y-8 text-muted-foreground">
          ...
          <p className="text-lg">
            <em>
              ...
              placeholder content that should be reviewed and updated to comply
          ...
          <section>
            ...
            <p>
              Shruti Turner ("we", "us", "our") is committed to protecting your
            ...
            <p>
              ...
              and process. We comply with the UK General Data Protection
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                symptoms, injuries, limitations (for coaching services)
              </li>
              <li>
              ...
              <li>
                <strong>Dietary requirements:</strong> Allergies, preferences
                (for retreats and events)
              </li>
            </ul>

            <h3 className="text-xl text-foreground mb-3 mt-6">
              2.2 Information Collected Automatically
            </h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Website usage:</strong> Pages visited, time spent, browser
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Provide services:</strong> Deliver coaching, classes,
                retreats, and other services you've purchased
              </li>
              <li>
                <strong>Personalize programming:</strong> Adapt training and yoga
                practices to your specific needs and conditions
              </li>
              <li>
                <strong>Process payments:</strong> Handle billing and
                transactions
              </li>
              <li>
                <strong>Communicate:</strong> Send booking confirmations,
                program details, and service updates
              </li>
              <li>
                <strong>Newsletter:</strong> Send educational content (only if
                you've subscribed)
              </li>
              <li>
                <strong>Safety:</strong> Ensure appropriate medical considerations
                are taken during physical activities
              </li>
              <li>
                <strong>Improve services:</strong> Analyze usage to enhance our
                offerings
              </li>
              <li>
                <strong>Legal compliance:</strong> Meet regulatory and legal
                obligations
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Legitimate interests:</strong> To improve services and
                ensure safety
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                email service providers, website hosting
              </li>
              <li>
                <strong>Emergency contacts:</strong> In case of medical
                emergencies during services
              </li>
              <li>
                <strong>Medical professionals:</strong> Only with your explicit
                consent
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              We collect sensitive health information to provide safe and
              appropriate services. This is processed based on your explicit
              consent and our legitimate interest in ensuring your safety during
              physical activities.
            </p>
            <p>
              Health information is stored securely and accessed only by
              authorized personnel who need it to provide your services.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                relationship plus 6 years (for legal and tax purposes)
              </li>
              <li>
                <strong>Newsletter subscribers:</strong> Until you unsubscribe
              </li>
              <li>
                <strong>Website visitors:</strong> Analytics data aggregated and
          ...
          <section>
            <h2 className="text-2xl text-foreground mb-4">9. Your Rights</h2>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Withdraw consent:</strong> For processing based on
                consent
              </li>
            </ul>
            <p>
              ...
              <a
                href="mailto:privacy@shrutiturner.com"
          ...
          <section>
            ...
            <p>
              Your data is primarily stored in the UK/EU. Some service providers
              may process data outside the EEA. We ensure appropriate safeguards
          ...
          <section>
            ...
            <p>
              ...
              this page with an updated date. Significant changes will be
