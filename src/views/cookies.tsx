  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl md:text-5xl mb-8">Cookie Policy</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-muted-foreground">
          ...
          <p className="text-lg">
            <em>
              ...
              placeholder content that should be reviewed and updated based on
              actual cookies used on the site.
            </em>
          </p>
          ...
          <section>
            ...
            <p>
              We use cookies and similar technologies (like local storage and
          ...
          <section>
            ...
            <p>
              ...
              enable basic features like page navigation, secure areas, and
              payment processing. The website cannot function properly without
              these cookies.
            </p>
            ...
            <p>
              These cookies help us understand how visitors use our website. We
              use this information to improve the website and user experience.
            </p>
            <div className="bg-secondary/30 p-4 rounded-lg my-4">
              <p className="text-sm">
                ...
                <br />
                <strong>Purpose:</strong> Track page views, time on site,
                navigation patterns
                <br />
            ...
            <p>
              ...
              relevant advertising. We only use marketing cookies with your
              consent.
            </p>
            <div className="bg-secondary/30 p-4 rounded-lg my-4">
              <p className="text-sm">
                ...
                <br />
                <strong>Purpose:</strong> Show relevant ads, measure campaign
                effectiveness
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Google Analytics:</strong> Website analytics (if you
                consent)
              </li>
              <li>
              ...
              <li>
                <strong>Email service provider:</strong> To track newsletter
                engagement
              </li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              ...
              you can accept or decline optional cookies. You can change your
            ...
            <p className="mt-4">
              Note: Blocking all cookies may affect website functionality. Some
          ...
          <section>
            ...
            <p>
              Some browsers have "Do Not Track" features. Currently, there is no
              universal standard for how websites should respond to these
              signals. We do not currently respond to Do Not Track signals, but
          ...
          <section>
            <h2 className="text-2xl text-foreground mb-4">
              7. Cookie List & Details
            </h2>
            <p className="text-sm italic">
              Below is a detailed list of cookies we use (this would be
          ...
          <section>
            <h2 className="text-2xl text-foreground mb-4">9. More Information</h2>
            <p>
