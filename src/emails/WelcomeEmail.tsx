        ...
        <Body className="bg-background font-sans">
          <Container className="mx-auto p-4 max-w-xl">
            ...
            <Section className="bg-white p-8 rounded-lg border border-[#E5E5E5]">
              ...
              <Text className="text-text text-base leading-relaxed mb-4">
                I'm so glad you're here. This space is built for bodies that need more than generic fitness advice—bodies that are complex, intelligent, and capable of building immense capacity.
              </Text>

              <Text className="text-text text-base leading-relaxed mb-6">
                Whether you're here for rehabilitation-informed yoga, strength training, or simply to explore what your body can do without pain, you've taken the first step.
              </Text>
              ...
              <ul className="text-text text-sm list-disc pl-5 mb-6 space-y-2">
                <li>Complete your <Link href="https://shrutiturner.com/dashboard/health-profile" className="text-primary underline">Health Profile</Link> so I can support you best.</li>
                <li>Read the <Link href="https://shrutiturner.com/guidelines" className="text-primary underline">Studio Guidelines</Link> to understand our calm, respectful culture.</li>
